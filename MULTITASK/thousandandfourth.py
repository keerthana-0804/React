...
class Environment:
    ...
    def reset(self):
        self.agent = Agent()
        self.items = [[random.randrange(0, SCREEN_WIDTH - GRID_SIZE, GRID_SIZE),
                       random.randrange(0, SCREEN_HEIGHT - GRID_SIZE, GRID_SIZE), item] for item in
                      [WOOD, IRON, GOLD, TOOLSHED, GRASS, FURNACE]]
