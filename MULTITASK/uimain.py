...
def main():
    ...
    if len(sys.argv) >= 3:
        parsed_task1 = sys.argv[1]
        parsed_task2 = sys.argv[2]
        
        print("Task 1:", parsed_task1)
        print("Task 2:", parsed_task2)
        ...
        print("Please provide Task 1 and Task 2 as command-line arguments.")
